...
* **ИС** - направление Информационные Системы и Технологии, 09.03.02. Название программы: "Разработка программного обеспечения / Software engineering". Называется ИС по названию бывшей кафедры Информационных Систем.
...
* **Коридорка** - тип комнаты на Вязьме, с двумя или тремя местами, при этом туалет и душевые находятся на этажах.
