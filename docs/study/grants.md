...
- Начисление стипендии происходит 3-5 числа месяца за предыдущий (то есть, например, стипендия за сентябрь придет 3-5 октября). Стипендии за декабрь и за апрель приходят до конца текущего месяца (то есть за декабрь в конце декабря, за апрель в конце апреля).
...
**Норматив**: 2 300 рублей, если закрыться без троек, 4 600 рублей, если закрыться только на «отлично».
...
:::note
Формально стипендия за билет — это тоже ГАС, поэтому они не суммируются. Это значит, что при выполнении условий на серебряный билет вы будете получать 10 000 рублей, а не 12 300. Аналогично во втором семестре: даже при закрытии на отлично и продлении стипендии ITMO.Family вы будете получать 10 000 рублей, а не 14 600.
:::
...
**Норматив**: зависит от набранной суммы баллов, можно ориентироваться на диапазон от 14 800 до 41 800 рублей. При этом каждый семестр размер стипендии (и условный «курс конвертации» баллов в стипендию) определяется заново.
...
:::note
В эту сумму входит социальная стипендия (3 400 рублей) и сама повышенная социальная стипендия (8 875 рублей). То есть технически стипендия будет больше за счёт ГАС.
:::
...
**Норматив**: в большинстве случаев 4 000 рублей. Точные суммы для каждой категории студентов определяются положением, которое можно найти по ссылке выше.
