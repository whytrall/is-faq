...
- Дырявые окна + плохое отопление = холод. Зимой, да и летом когда пасмурно, дождь, ветер и т.д.
...
- Учитывая всё выше перечисленное, цена в +5к заставляет задуматся о смысле пребывания в этом месте.(Такие цены только для студентов из ИТМО, другие платят меньше(или больше?))
