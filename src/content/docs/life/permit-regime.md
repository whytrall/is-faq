...
Для гостей можно создавать одноразовый QR-код в ИСУ, подав соответствующую заявку (_Личный кабинет > IT-сервисы > Электронный пропуск > Пригласить гостя_). Приглашая гостя, вы полностью берёте на себя ответственность за действия приглашаемого человека.
