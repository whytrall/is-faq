...
И несколько общежитий, подробную информацию о которых можно почитать, тыкнув [сюда](/other/dorm.md).
...
Все вопросы по поводу [военной кафедры](/other/army.md) решаются здесь.
