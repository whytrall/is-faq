...
* **Допса** - дополнительная сессия для закрытия долгов. Начинается после окончания каникул после предыдущего семестра. Более формально назвается **ППА** - повторная промежуточная аттестация.
